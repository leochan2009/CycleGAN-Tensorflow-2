...
A_B_dataset, len_dataset = data.make_zip_dataset_from_single_dir(py.join(args.datasets_dir, 'train'), args.batch_size, args.load_size, args.crop_size, training=True, repeat=False)

A2B_pool = data.ItemPool(args.pool_size)
B2A_pool = data.ItemPool(args.pool_size)

A_B_dataset_test, _ = data.make_zip_dataset_from_single_dir(py.join(args.datasets_dir, 'test'), args.batch_size, args.load_size, args.crop_size, training=False, repeat=True)
